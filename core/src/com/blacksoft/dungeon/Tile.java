...
public enum Tile {
    ...
    static {
        ...
        Empty.canMergeWith = Arrays.asList(Empty, BloodPool, DungeonEntrance, Treasury, RestingArea, GateOpened, GateClosed);
        ...
        BloodPool.canMergeWith = BloodPool.canMergeWith = Arrays.asList(BloodPool);
